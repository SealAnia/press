...
<body>
	...
	<c:url value="/editarticle" var="article"/>
	
	<spring_form:form action="${article}" method="post" modelAttribute="newArticle"
	class = "edition">
	
	<spring_form:hidden path="articleid" value = "${newArticle.articleid}"/>
